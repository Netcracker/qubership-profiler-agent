...
public class ThreadJMXMemoryLegacy implements ThreadJMXMemoryProvider {
    private static boolean DEBUG = Boolean.getBoolean(ThreadJMXMemoryLegacy.class.getName() + ".debug");
    private static final ESCLogger logger = ESCLogger.getLogger(ThreadJMXMemoryLegacy.class, (DEBUG ? Level.FINE : ESCLogger.ESC_LOG_LEVEL));
