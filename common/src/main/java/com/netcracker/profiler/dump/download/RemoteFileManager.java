...
public class RemoteFileManager implements Closeable {
    ...
    public RemoteFileManager(String remoteHost, String userName, String password, String shell) {
        this.jsch = new JSch();
    ...
    public synchronized void preloadRecursiveChild(RemoteFile file, String ignore) throws IOException {
        String command = "ls -l -L -R --time-style +%s --color=none " + (ignore == null ? "" : " -I " + ignore) + " " + file.getPath();
    ...
    synchronized List<RemoteFile> listFiles(RemoteFile file) throws IOException {
        String lsOutput = execCommand("ls -l -L --time-style +%s --color=none " + file.getPath());
    ...
    synchronized void readAttrs(final RemoteFile file) throws IOException {
        try {
            String lsOutput = execCommand("ls -ld -L --time-style +%s --color=none " + file.getPath());
