pluginManagement {
    plugins {
        id("com.github.vlsi.crlf") version "3.0.0"
        id("com.github.vlsi.gettext") version "3.0.0"
        id("com.github.vlsi.gradle-extensions") version "3.0.0"
        id("com.github.vlsi.ide") version "3.0.0"
