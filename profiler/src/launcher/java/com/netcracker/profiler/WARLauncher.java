...
public class WARLauncher {
    ...
    private static boolean attemptCLI(String[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException, ClassNotFoundException {
        Class cli = nestedJarsClassLoader.loadClass("com.netcracker.profiler.cli.Main");
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, LifecycleException {
        ...
        try{
            ...
            System.setProperty("com.netcracker.profiler.Installer.skip", "true");
            System.setProperty("com.netcracker.profiler.skip.nonactive", "true");
    ...
    private static String getDumpRootFromDumpRootResolver() {
        try {
            return (String)nestedJarsClassLoader.loadClass("com.netcracker.profiler.dump.DumpRootResolver").getDeclaredField("dumpRoot").get(null);
        } catch (Exception e) {
    ...
    private static void setDumpRootOnDumpRootResolver(String dumpRoot) {
        try {
            nestedJarsClassLoader.loadClass("com.netcracker.profiler.dump.DumpRootResolver").getDeclaredField("dumpRoot").set(null, dumpRoot);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    private static String getProfilerHomeFromDumpRootResolver() {
        try {
            return (String)nestedJarsClassLoader.loadClass("com.netcracker.profiler.dump.DumpRootResolver").getDeclaredField("PROFILER_HOME").get(null);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
