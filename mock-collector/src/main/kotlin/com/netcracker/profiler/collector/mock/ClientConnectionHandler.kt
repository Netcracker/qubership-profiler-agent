...
class ClientConnectionHandler(
    ...
    private fun performHandshake() {
        ...
        log.info("Client handshake: pod={}, microservice={}, namespace={}, version={}",
    ...
    private fun handleInitStream() {
        ...
        log.info("Initializing stream: name={}, rollingSeqId={}, reset={}",
    ...
    private fun handleReceiveData() {
        ...
        // Log received data
        dataLogger.logData(streamInfo.name, data, dataLength,
