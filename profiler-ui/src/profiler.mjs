    ...
    if (app.name == 'CallTree')
        (function() {
            ...
            CT.defaultCategories = [
                ...
                'solutions.ossj org.qubership.applications.ossj.base.controller.AbstractBusinessController.invoke',
                '',
                '# Orchestrator',
                'orchestrator.mdb org.qubership.platform.utils.tools.queueservice.QueueInvokerMDB',
                'orchestrator.core org.qubership.platform.orchestrator.core.orm.SafeLifecycleManager',
                'orchestrator.manual_task org.qubership.platform.orchestrator.usertask.OrchestratorUserTaskOperations.prepareUserTask',
                '',
                '# Custom code called from orchestrator',
                'solutions.orchestrator.sync >org.qubership.platform.orchestrator.core.actions.synchronous.SynchronousJavaActionExecutor.executeAction',
                'solutions.orchestrator.async >org.qubership.platform.orchestrator.core.actions.asynchronous.AsynchronousJavaActionExecutor.executeAction',
                'solutions.orchestrator.manual_task >org.qubership.platform.orchestrator.core.actions.manualtask.ManualTaskActionExecutor.executeAction',
                'solutions.orchestrator.js_condition >org.qubership.platform.orchestrator.core.scripting.ProcessBasedScriptingEngine.execute',
                '',
                '# Workflow',
                'workflow.engine.unsorted org.qubership.ejb.wf.interface2.WfSubscriberSysJMSBean.onMessage',
                'workflow.engine.unsorted >org.qubership.platform.orchestrator.core.actions.workflow.WorkflowExecutor.executeAction',
                'workflow.engine.load_opeartions_cache org.qubership.ejb.wf.engine.processor.OperationCache.reloadNames2NodesCache',
                'workflow.engine.load_opeartions_cache org.qubership.ejb.wf.engine.processor.OperationCache.getOperationNodes',

                '',
                '# Custom Workflow code',
                'solutions.workflow >org.qubership.ejb.wf.engine.processor.ActionProcessor.invoke',
                'solutions.workflow >org.qubership.ejb.wf.engine.processor.ActionProcessor.execute',
                '',
                '# Custom JSP code',
                'solutions.jsp.unsorted org.qubership.jsp.Sheet.service',
                'solutions.jsp.get_data Provider.getObjectsByRequestWithMP',
                'solutions.jsp.get_data Provider.getRecordCount',
                'solutions.jsp.sort_data org.qubership.ejb.session.common.CommonProviderBean.sort',
                'solutions.jsp.calculate_attributes org.qubership.ejb.session.common.providers.ProviderSceleton.calculate',
                'solutions.jsp.calculate_attributes org.qubership.ejb.session.common.ProviderHelper.calculate',
                'solutions.jsp.compute_filters org.qubership.ejb.session.common.CommonProviderBean.getAvailableValues',
                'solutions.jsp.compute_filters solutions.jsp.compute_filters org.qubership.ejb.session.common.providers.PortContextProvider.ensureAvalibleValues',
                'solutions.cbtui.unsorted org.qubership.presentation.config.ActionNode.perform',
                '',
                '# JSP framework',
                'tui.jsp.print_html org.qubership.jsp.Sheet.printContent',
                'tui.jsp.print_object_parameters org.qubership.jsp.uni.control.ParameterCtrl.newPrint',
                'tui.jsp.unsorted org.qubership.jsp.CommonPage.debugSecureService',
                'tui.jsp.calculate_page_structure.determine_header org.qubership.jsp.BasicDesign.getHead',
                'tui.jsp.calculate_page_structure.determine_sheets org.qubership.ejb.session.common.CommonProviderBean.init',
                'tui.jsp.calculate_page_structure.determine_sheets org.qubership.jsp.ModernPage.setMainObject',
                'tui.jsp.calculate_page_structure.determine_columns org.qubership.ejb.session.common.CommonProviderBean.getObjectsDisplayedAttributes',
                'tui.jsp.calculate_page_structure.build_navigation_menu org.qubership.jsp.ModernPage.fillDepartments',
                'tui.jsp.calculate_page_structure.build_object_path org.qubership.jsp.path.PathBuilder',
                'tui.jsp.data_to_xml org.qubership.ejb.session.common.CommonProviderBean.buildXMLForObjects',
                'tui.jsp.check_security solutions.jsp.check_security org.qubership.ejb.session.common.ProviderHelper.filterByPermissions',
                'cbtui.unsorted org.qubership.presentation.process.NCControllerServlet.service',
                '',
                '# Search',
                'search.calculate_page_structure.determine_profiles org.qubership.platform.search.jsp.facade.FavoriteProfilesFacade.getFavoriteProfilesModel',
                '',
                '# Custom job',
                'solutions.job >org.qubership.platform.scheduler.impl.jobs.AbstractJobImpl$4.run',
                '',
                '# Scheduler',
                'scheduler org.qubership.platform.scheduler.impl.jobs.AbstractJobImpl.execute',
            ].join('\n');
