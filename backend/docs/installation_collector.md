...
| DIAG_PV_INSERT_CRON         | * * * * *                                                                        | -             | Cron schedule for the insert/index task that scans PV for new dump files and stores their metadata in the database                                                                                                                                                                                                                                                                                                  |
| DIAG_PV_ARCHIVE_CRON        | 6 * * * *                                                                        | -             | Cron schedule for the archive/pack task that compresses hourly dump directories into ZIP archives                                                                                                                                                                                                                                                                                                                   |
| DIAG_PV_DELETE_CRON          | 30 * * * *                                                                       | -             | Cron schedule for the cleanup task that removes dump data older than DIAG_PV_DAYS_DELETE_AFTER days. Also runs once at startup after rescan                                                                                                                                                                                                                                                                         |
